...
LSEQTree.prototype.get = function(index){
    ...
    return this.root.get(index+1); // (TODO) +1 sure ? 
};
...
LSEQTree.prototype.insert = function(element, index){
    ...
    var pi = (new ID(null, [], [])).fromNode(pei);
    var qi = (new ID(null, [], [])).fromNode(qei);
...
LSEQTree.prototype.applyInsert = function(e, i){
    ...
    tempNode.e = e;
    this.root.add(node);
    return (this.root.getIndex(node)-1); // (TODO) or -2 ?
};
